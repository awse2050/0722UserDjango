...
public interface RecommendService {
    ...
    default Recommend bindToEntity(RecommendDTO dto) {
        Recommend entity = Recommend.builder().rno(dto.getRno()).rid(dto.getRid()).itemID(dto.getItemID())
    ...
    default RecommendDTO bindToDTO(Recommend entity) {
        RecommendDTO dto = RecommendDTO.builder().rno(entity.getRno()).rid(entity.getRid()).itemID(entity.getItemID())
